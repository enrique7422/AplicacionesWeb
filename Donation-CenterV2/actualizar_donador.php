...
<form action="perfiles/update-don.php" method="POST" class="formulario">
     ...
     <div class="input-contenedor">
        ...
        <div id="outer" styele="width:100%; text-align: center;">
              ...
              <div class="inner" style="display: inline-block;">
                <a href="panel_donador.php"><input type="button" class="button" value="Cancelar" style="width:227px; text-align:center"></a>
              </div>     
