...
$consulta = "SELECT direccion, latitud, longitud FROM rutas WHERE id_ruta='$id'";
...
<form action="perfiles/update-ruta.php" method="POST" class="formulario">
<div class="w3-container">

    <h2 style="text-align:center;">Actualizar Ruta De Destino </h2>
    <br>
      ...
      <div class="col-sm-8">
        ...
        <div class="input-contenedor">
            ...
            <input id="txtDireccion" type="text" placeholder="Dirección" name="direccion" value="<?php foreach($data as $dat) { ?> <?php echo $dat['direccion'] ?><?php
        }
        ?>"
        ...
        <input id="txtLatitud" type="text" name="lat" value="<?php foreach($data as $dat) { ?> <?php echo $dat['latitud'] ?>
        <?php
        }
        ?>"
        ...
        <input id="txtLongitud" type="text" name="lon" value="<?php foreach($data as $dat) { ?> <?php echo $dat['longitud'] ?>
        <?php
        }
        ?>"
        ...
        <div id="outer" styele="width:100%; text-align: center;">
              ...
              <div class="inner" style="display: inline-block;">
                <a href="direcciones_admin.php"><input type="button" class="button" value="Cancelar" style="width:227px; text-align:center"></a>
              </div>     
